...
| 항목 | 예상 규모 |
|------|----------|
| **구축 비용** | 0.5억 ~ 0.8억 (WebView 기반 재사용 기준) |
| **개발 기간** | 2 ~ 3개월 |
| **연간 운영비** | 구축비의 15~20% |
...
| **기존 앱과 중복** | MGeshop 등 기존 앱과 기능 중복 | 통합 운영 또는 역할 분리(복지몰 vs 쇼핑) |
...
| 🟢 **참고** | 기존 앱(MGeshop) 설치자 수 및 이용 통계 | 통합 vs 별도 운영 결정 |
